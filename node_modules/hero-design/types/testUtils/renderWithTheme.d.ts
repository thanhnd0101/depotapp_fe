...
declare const renderWithTheme: (ui: ReactElement, options?: RenderOptions<typeof import("@testing-library/dom/types/queries"), HTMLElement> | undefined) => {
    getAllByText: (text: import("@testing-library/react").Matcher, options?: import("@testing-library/react").SelectorMatcherOptions | undefined, waitForElementOptions?: unknown) => import("./UnsafeArray").UnsafeArray<HTMLElement>;
    getAllByDisplayValue: (text: import("@testing-library/react").Matcher, options?: import("@testing-library/react").MatcherOptions | undefined, waitForElementOptions?: unknown) => import("./UnsafeArray").UnsafeArray<HTMLElement>;
    findAllByText: (text: import("@testing-library/react").Matcher, options?: import("@testing-library/react").SelectorMatcherOptions | undefined, waitForElementOptions?: import("@testing-library/react").waitForOptions | undefined) => Promise<import("./UnsafeArray").UnsafeArray<HTMLElement>>;
    container: HTMLElement;
    baseElement: Element;
    debug: (baseElement?: Element | DocumentFragment | (Element | DocumentFragment)[] | undefined, maxLength?: number | undefined, options?: import("pretty-format/build/types").OptionsReceived | undefined) => void;
