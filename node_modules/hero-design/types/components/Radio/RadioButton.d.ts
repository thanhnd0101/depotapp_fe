...
declare const RadioButton: ({ name, text, value, disabled, checked, onChange, size, variant, id, className, style, "data-test-id": dataTestId, }: RadioButtonProps) => ReactElement;
