...
declare const SingleSlider: ({ min, max, step, value, disabled, alwaysShowTooltip, customTooltipText, id, className, style, "data-test-id": dataTestId, onChange, }: SingleSliderProps) => ReactElement;
