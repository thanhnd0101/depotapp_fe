...
declare const SelectButton: ({ text, value, selected, disabled, onChange, size, variant, name, id, className, style, "data-test-id": dataTestId, }: SelectButtonProps) => ReactElement;
