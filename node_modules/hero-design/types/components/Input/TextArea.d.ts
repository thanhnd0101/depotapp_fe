import { ChangeEvent, FocusEvent, ReactElement, TextareaHTMLAttributes } from 'react';
...
declare const TextArea: ({ value, onChange, onFocus, onBlur, autoResize, size, disabled, invalid, placeholder, name, id, className, style, autoComplete, autoFocus, "data-test-id": dataTestId, ...textAreaAttrs }: TextAreaProps) => ReactElement;
