...
export interface ResultProps extends CommonProps {
     ...
     */
    status?: 'success' | 'error' | 'info' | 'warning' | '404' | '403' | '500' | '503';
    /**
...
declare const Result: ({ extra, subTitle, title, status, icon, id, className, style, "data-test-id": dataTestId, }: ResultProps) => ReactElement;
