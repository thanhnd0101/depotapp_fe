...
declare const DragAndDrop: ({ text, description, onAccept, onReject, multiple, accept, maxSize, id, className, style, "data-test-id": dataTestId, }: DragAndDropProps) => ReactElement;
