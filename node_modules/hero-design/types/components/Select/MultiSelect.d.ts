import { ReactElement, ReactNode, CSSProperties, FocusEvent } from 'react';
import { Option as OptionType } from './utils';
...
declare const MultiSelect: ({ options, value, onBlur, onChange, onFocus, optionRenderer, selectedOptionRenderer, disabled, size, invalid, placeholder, prefix, onScrollListToBottom, loading, query, onQueryChange, noResults, name, onCreateNewOption, id, className, style, autoComplete, optionMenuStyle, "data-test-id": dataTestId, }: MultiSelectProps) => ReactElement;
