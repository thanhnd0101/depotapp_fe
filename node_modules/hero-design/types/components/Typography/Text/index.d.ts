...
export interface TextProps extends CommonProps {
     ...
     */
    intent?: 'main' | 'subdued' | 'primary' | 'success' | 'danger' | 'warning' | 'error' | 'white';
    /**
     * HTML tag name to use for rendered element.
     */
    tagName?: 'div' | 'p' | 'span' | 'label';
}
declare const Text: ({ children, intent, fontSize, fontWeight, tagName, htmlFor, id, className, style, "data-test-id": dataTestId, }: TextProps) => ReactElement;
export default Text;
