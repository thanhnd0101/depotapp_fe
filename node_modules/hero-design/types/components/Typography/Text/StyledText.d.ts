...
export interface StyledProps {
    ...
    themeIntent: 'main' | 'subdued' | 'primary' | 'success' | 'danger' | 'warning' | 'error' | 'white';
}
...
declare const StyledLabelInline: import("styled-components").StyledComponent<"label", import("styled-components").DefaultTheme, StyledProps & LabelHTMLAttributes<HTMLLabelElement>, never>;
