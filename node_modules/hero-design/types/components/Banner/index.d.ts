...
export declare const getBannerIcon: (defaultIcon: IconName, icon: undefined | null | IconName | ReactElement) => Option<Either<IconName, ReactElement>>;
declare const Banner: ({ intent, title, content, icon, onClose, id, className, style, "data-test-id": dataTestId, }: BannerProps) => ReactElement;
