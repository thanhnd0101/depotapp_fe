...
/* eslint-disable no-shadow, @typescript-eslint/no-non-null-assertion */
...
export function flow(
  ...
  switch (arguments.length) {
    case 1:
      return ab;
    case 2:
      return (...args: Array<unknown>) => bc!(ab(...args));
    case 3:
      return (...args: Array<unknown>) => cd!(bc!(ab(...args)));
    case 4:
      return (...args: Array<unknown>) => de!(cd!(bc!(ab(...args))));
  }
  throw new Error(
...
export const always = <A>(a: A) => (_b: any) => a;

export const invokeWith = <A, B>(a: A) => (fn: (fa: A) => B) => fn(a);

export const invoke = <A, B>(fn: (a: A) => B) => (a: A) => fn(a);

export const equal = <A>(a1: A) => (a2: A) => a1 === a2;
