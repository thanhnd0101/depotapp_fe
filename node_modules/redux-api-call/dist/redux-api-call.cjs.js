...
var ACTION_DISPOSE = '@@api/DISPOSE';
...
}), _defineProperty(_handleActions, ACTION_DISPOSE, function (state, action) {
  var apiName = getName(action);
  if (state.hasOwnProperty(apiName)) {
    var disposed = state[apiName],
        newState = _objectWithoutProperties(state, [apiName]);
...
exports.composeAdapters = compose$1;
